...
const Step3 = ({ changeIndex, index, state, changeState }) => {
					...
					<BouncyDiv>
						...
						>
							<div className={classes.title}>
								Name of your project (or) website link (or) social media
								platform ?
							</div>
							<div>
								<CssTextField
									...
									onChange={(e) => {
										changeState({
											...
											question:
												'Name of your project (or) website link (or) social media platform ?',
											level: index
										})
									}}
								/>
