...
const StakeNavbar = ({ history, show, setShow, setmode, mode }) => {
				...
				<div className='d-flex justify-content-between home__navbar'>
					...
					<div className='d-flex justify-content-center align-self-center'>
                        ...
                        <Link to={'/stakes'}>Developers</Link>
							...
							{/* <li className='nav__link'>STAKING</li> */}
						</ul>
					</div>
...
'
						...
						<button
							type='button'
							className='btn btn-primary navbar__button d-none d-lg-block mr-5 ml-1'
							onClick={() => {
								history.push('/stakes')
							}}
						>
